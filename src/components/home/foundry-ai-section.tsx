    ...
    <Section className="border-t border-white/[0.06]">
      <Container>
        <FadeIn className="mx-auto max-w-2xl text-center">
          <SectionLabel>Built in · Product preview</SectionLabel>
          <SectionHeading className="mt-7">
            Meet <span className="text-molten">Foundry AI</span>
          </SectionHeading>
        ...
        <FadeIn delay={0.1} className="mt-14 md:mt-16">
          <BrowserFrame url="app.foundry.com/assistant" className="mx-auto max-w-3xl">
            {/* Assistant header */}
